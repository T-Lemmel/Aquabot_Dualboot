...
static const _CentroidWithRadius_type_support_symbol_names_t _CentroidWithRadius_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, msg, CentroidWithRadius)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_interfaces, msg, CentroidWithRadius)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_interfaces, msg, CentroidWithRadius)() {
  return &::my_robot_interfaces::msg::rosidl_typesupport_c::CentroidWithRadius_message_type_support_handle;
}
