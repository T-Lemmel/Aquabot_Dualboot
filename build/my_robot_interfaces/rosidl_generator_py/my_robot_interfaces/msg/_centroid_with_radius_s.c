...
bool my_robot_interfaces__msg__centroid_with_radius__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces.msg._centroid_with_radius.CentroidWithRadius", full_classname_dest, 64) == 0);
  }
  my_robot_interfaces__msg__CentroidWithRadius * ros_message = _ros_message;
  {  // position
...
{
  /* NOTE(esteve): Call constructor of CentroidWithRadius */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces.msg._centroid_with_radius");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CentroidWithRadius");
